...
\title{Recurrent Depth in Z1T: A Quality--Storage Trade-off}
\author{Kirk Stapff}
\date{September 2026}
...
All $18$ confirmation runs used NVIDIA H100 80GB HBM3 GPUs. Model arrays used float32 with \texttt{jax\_default\_matmul\_precision=None}. Recorded packages: Python $3.12.14$, JAX/jaxlib $0.11.1$, Equinox $0.13.8$, Optax $0.2.8$, NumPy $2.5.3$. Tokenizer: GPT-2 BPE via tiktoken $0.12.0$. Checksums:
\begin{itemize}
  \setlength{\itemsep}{0.25em}
  \item prepared-manifest SHA256: \path{53a5313d3fb3ae3a95e1a854d929524390e37ce05f32598e783e01014d3ce364}
  \item source-document SHA256: \path{c98854af7dae63b01eaf03d29a1d6b66236b312b76ca928d6d7c75987474f588}
  \item \texttt{encoder.json} SHA256: \path{196139668be63f3b5d6574427317ae82f612a97c5d1cdaf36ed2256dbf636783}
  \item \texttt{vocab.bpe} SHA256: \path{1ce1664773c50f3e0cc8842619a93edc4624525b728b188a9e0be33b7726adc5}
\end{itemize}

Checksummed metrics live in \path{artifacts/claim-a/}. Figures regenerate with \texttt{uv run python} \path{scripts/analyze_claim_a.py} and \texttt{uv run python} \path{scripts/make_paper_figures.py}. Full-state checkpoints are not in git. First-wave launcher provenance files inherit the label \path{duration-v1} from an earlier launcher; run configs and identities are claim-A. One registered U12 seed-$12$ run was retrained under the same identity after an infrastructure archive failure; it is not a replacement seed. Some earlier development checkpoints were not fully archived.
